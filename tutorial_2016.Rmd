...
__Resposta__: Não faço a mais parva idéia! A covariância depende da escala! Vamos olhar para a correlação (usando a função cor), que tem escala absoluta.
...
Agora vamos medir as covariâncias e correlações dentro de cada espécis. Para isso, vamos aprender a escolher apenas algumas linhas de uma tabela de dados no R. Suponha que eu queira ver apenas as linhas que sejam da espécie A. Posso fazer isso com o comando:
